...
import { CATALOG_COLLECTIONS, CATALOG_COLUMNS, CATALOG_SIDEBAR } from '#/shared/data/home';
import type { CatalogLink } from '#/shared/types';
import { assetUrl } from '#/shared/lib/assetUrl';

import { ChevronRightIcon } from '#/shared/ui/icons/MegaMenuIcons';
  ...
  return (
    <div className={styles.stub}>
      <img
        ...
        src={assetUrl('assets/webp/catalog-stub-cat.webp')}
        alt=""
      />
    </div>
  );
