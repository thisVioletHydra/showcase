...
export function calculateDiscountedPrice(basePrice, currency, promocode) {
...
export function applyPromocode(orderId, code) {
    const db = getDb();
...
export function previewPromocode(code, basePrice, currency) {
...
export function isValidPromocodeType(value) {
